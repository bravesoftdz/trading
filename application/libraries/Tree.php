...
************************************************************************************************************/	
		...
		*/
		...
		function expandAll()
		{
            ...
            var treeObj = document.getElementById('tree_folder_open');
		...
		{
			var treeObj = document.getElementById('tree_folder');
			var images = treeObj.getElementsByTagName('IMG');
			for(var no=0;no<images.length;no++){
	...
	*/
	...
	function addToArray($id,$name,$parentID,$url="",$target="",$imageIcon="dhtmlgoodies_folder1.gif"){

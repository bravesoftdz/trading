							...
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								...
    								?>
    									...
    									<td border="0">
    										<a title="Edit Ukuran" href="<?php echo base_url(); ?>px/ukuran/change/<?php echo $row->ukuranid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>px/ukuran/delete/<?php echo $row->ukuranid; ?>'}" title="Hapus ukuran" >

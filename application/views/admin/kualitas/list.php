							...
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								...
    								?>
    									...
    									<td border="0">
    										<a title="Edit Kualitas" href="<?php echo base_url(); ?>px/kualitas/change/<?php echo $row->kualitasid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>px/kualitas/delete/<?php echo $row->kualitasid; ?>'}" title="Hapus kualitas" >

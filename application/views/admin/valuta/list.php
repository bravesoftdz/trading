							...
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								...
    								?>
    									...
    									<td border="0">
    										<a title="Edit Valuta" href="<?php echo base_url(); ?>px/valuta/change/<?php echo $row->valid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>px/valuta/delete/<?php echo $row->valid; ?>'}" title="Hapus Valuta" >

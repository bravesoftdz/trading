                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="input-medium form-control" 
                                                        id="motifid" placeholder="Entry Motif ID" style="float: left; margin: inherit; text-transform: uppercase;" 
                                                            name="motifid">
                                                </td>
                                            </tr>
                            				<tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="input-xlarge form-control" 
                                                        id="description" placeholder="Entry Nama Motif" style="float: left; text-transform: uppercase; 

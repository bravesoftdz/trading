							...
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								...
    								?>
    									...
    									<td border="0">
    										<a title="Edit Motif" href="<?php echo base_url(); ?>motif/change/<?php echo $row->motifid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>motif/delete/<?php echo $row->motifid; ?>'}" title="Hapus motif" >

							...
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								...
    								?>
    									...
    									<td border="0">
    										<a title="Edit golongan" href="<?php echo base_url(); ?>golongan/change/<?php echo $row->golonganid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>golongan/delete/<?php echo $row->golonganid; ?>'}" title="Hapus golongan" >

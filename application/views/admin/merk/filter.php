							...
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								...
    								?>
    									...
    									<td border="0">
    										<a title="Edit merk" href="<?php echo base_url(); ?>merk/change/<?php echo $row->merkid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>merk/delete/<?php echo $row->merkid; ?>'}" title="Hapus merk" >

                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="input-medium form-control" 
                                                        id="jenisid" placeholder="Entry Jenis ID" style="float: left; margin: inherit; text-transform: uppercase;" 
                                                            name="jenisid">
                                                </td>
                                            </tr>
                            				<tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="input-xlarge form-control" 
                                                        id="description" placeholder="Entry Nama Jenis" style="float: left; text-transform: uppercase; 

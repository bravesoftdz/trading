			...
			<div class="span12">				
				<div class="row">
					...
					<div class="span9">
						...
						<h5>Daftar Jenis, diurutkan berdasarkan data dimutahirkan.</h5><br />
						<h5>Semua Jenis berjumlah sebanyak: <?php echo $count; ?> record(s).</h5><br />                                                                       	                                                                       
                       <!-- <a  style="float:right; margin:18px;width:auto" href="<?php echo base_url() ?>umum/setting/form/" class="dark_green btn cbKota">Tambah Data Kota</a>-->                                                 
                        <div class="well blue">                                                    
							<div class="well-header">
                                <form class="inline" role="form" action="<?php echo base_url() ?>px/jenis/filter/" method="post">
                                    <div class="form-group">                
                                        <button type="submit" class="btn btn-info" style="float: right;" onclick="<?php echo base_url() ?>px/jenis/list_">Clear</button>                                                                                                                                                                                                                                                                    
                                ...
                                <h5 style="width:auto">List Daftar Jenis </h5><br/>	
							</div>
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								<thead>	
                                        ...
                                        <a title="Tambah Data Jenis" href="<?php echo base_url(); ?>px/jenis/new_/">
    											<i class="icon-add"></i> Tambah Data Jenis
    										</a>
                                        </th>                                    
    								</thead>
    								<tr>
    								...
    								?>
                                        ...
                                        <td style="text-transform: uppercase;"><?php echo ucwords($row->jenisid); ?></td>
    									<td style="text-transform: uppercase;"><?php echo ucwords($row->description); ?></td>																		
    									<td border="0">
    										<a title="Edit Jenis" href="<?php echo base_url(); ?>px/jenis/change/<?php echo $row->jenisid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>px/jenis/delete/<?php echo $row->jenisid; ?>'}" title="Hapus Jenis" >

							...
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								...
    								?>
    									...
    									<td border="0">
    										<a title="Edit Jenis" href="<?php echo base_url(); ?>jenis/change/<?php echo $row->jenisid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>jenis/delete/<?php echo $row->jenisid; ?>'}" title="Hapus Jenis" >

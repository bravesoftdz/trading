							...
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								...
    								?>
    									...
    									<td border="0">
    										<a title="Edit Warna" href="<?php echo base_url(); ?>warna/change/<?php echo $row->warnaid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>warna/delete/<?php echo $row->warnaid; ?>'}" title="Hapus warna" >

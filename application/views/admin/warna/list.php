			...
			<div class="span12">				
				<div class="row">
					...
					<div class="span9">
						...
						<h5>Daftar Warna, diurutkan berdasarkan data dimutahirkan.</h5><br />
						<h5>Semua Warna berjumlah sebanyak: <?php echo $count; ?> record(s).</h5><br />                                                                       	                                                                       
                       <!-- <a  style="float:right; margin:18px;width:auto" href="<?php echo base_url() ?>umum/setting/form/" class="dark_green btn cbKota">Tambah Data Kota</a>-->                                                 
                        <div class="well blue">                                                    
							<div class="well-header">
                                <form class="inline" role="form" action="<?php echo base_url() ?>px/warna/filter/" method="post">
                                    <div class="form-group">                
                                        <button type="submit" class="btn btn-info" style="float: right;" onclick="<?php echo base_url() ?>px/warna/list_">Clear</button>                                                                                                                                                                                                                                                                    
                                ...
                                <h5 style="width:auto">List Daftar Warna </h5><br/>	
							</div>
							<div class="well-content">
    							...
    							<table class="table table-striped table-bordered"><!-- table default style -->
    								<thead>	
                                        ...
                                        <a title="Tambah Data Warna" href="<?php echo base_url(); ?>px/warna/new_/">
    											<i class="icon-add"></i> Tambah Data Warna
    										</a>
                                        </th>                                    
    								</thead>
    								<tr>
    								<?php $no=1; 
    									foreach($warna->result() as $row){ 
    								?>
    									<td><?php echo $this->session->userdata('row')+$no; ?></td>
                                        <td style="text-transform: uppercase;"><?php echo ucwords($row->warnaid); ?></td>
    									<td style="text-transform: uppercase;"><?php echo ucwords($row->description); ?></td>																		
    									<td border="0">
    										<a title="Edit Warna" href="<?php echo base_url(); ?>px/warna/change/<?php echo $row->warnaid; ?>">
    											<i class="icon-edit"></i> Edit
    										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>px/warna/delete/<?php echo $row->warnaid; ?>'}" title="Hapus Warna" >

                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="input-medium form-control" 
                                                        id="warnaid" placeholder="Entry Warna ID" style="float: left; margin: inherit; text-transform: uppercase;" 
                                                            name="warnaid">
                                                </td>
                                            </tr>
                            				<tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="input-xlarge form-control" 
                                                        id="description" placeholder="Entry Nama Warna" style="float: left; text-transform: uppercase; 
